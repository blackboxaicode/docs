---
title: Responses
description: Learn about response from BLACKBOXAI API
---

## Completions Response Format

BLACKBOXAI uses OpenRouter under the hood and it normalizes the schema across models and providers to comply with the [OpenAI Chat API](https://platform.openai.com/docs/api-reference/chat).
