...
1.  Navigate to the [API Keys section](https://www.blackbox.ai/dashboard/keys) of your BLACKBOX dashboard.
...
```bash
curl [https://www.blackbox.ai/api/v1/chat](https://www.blackbox.ai/api/v1/chat) \
