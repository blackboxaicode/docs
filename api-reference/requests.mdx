---
title: Requests
description: Learn about requests to BLACKBOXAI API
---
...
BLACKBOXAI supports asking models to complete a partial response. This can be useful for guiding models to respond in a certain way.
...
fetch('https://api.blackbox.ai/api/v1/chat/completions', {
  method: 'POST',
  headers: {
