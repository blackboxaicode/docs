...
description: "Step-by-step guide to install and set up the BLACKBOX AI VS Code extension."
---
...
![BLACKBOX AI Extension](/images/vscode-agent/vscode_extension-install_01.png)
...
![Connect BLACKBOX AI Account](/images/vscode-agent/vscode_connect-account_01.png)
...
![Browser Tool Selection](/images/vscode-agent/vscode_agent_tools_menu.png)
...
![Browser Tool Selection](/images/vscode-agent/vscode_agent_select_browser_tool.png)
