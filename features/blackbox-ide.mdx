...
![BlackBox IDE download button](/images/blackbox-ide/Download_IDE_Button.png)

### **Step 2: First Launch and Setup**
Once downloaded, open the IDE and you'll see the welcome screen:

![BlackBox IDE First Time](/images/blackbox-ide/BlackBox-IDE-first-time.png)

### **Step 3: Connect Your Account**
Click on "Connect" to link the IDE with your BLACKBOXAI account for full functionality:

![Connect BlackBox Account](/images/blackbox-ide/connect_blackbox_account.png)

### **Step 4: Open External Connection**
Click on "Open" to connect to external services and unlock all features:

![Click Open to Connect](/images/blackbox-ide/click_open_to_connect.png)

![Click on BLACKBOX IDE](/images/blackbox-ide/click_on_BLACKBOX-IDE.png)
...
![Fresh New Project](/images/blackbox-ide/fresh_new_project.png)

**Select Your AI Model:**
Choose the best AI model for your specific project needs:

![Select Your AI Model](/images/blackbox-ide/Select_your_AI_Model.png)

**See Your App Come to Life:**
Watch as your description transforms into a fully functional application:

![Final App](/images/blackbox-ide/FInal_app.png)

### **Option 2: Work on Existing Projects**
**Open Your Project Folder:**
Navigate to and open your existing project directory:

![Click Open Folder for Existing Projects](/images/blackbox-ide/click_open_folder_for_existing_projects.png)

Enhance your current projects with the help of BLACKBOXAI IDE:

![Work on Existing Projects](/images/blackbox-ide/work_on_existing_projects.png)
...
![Supervise and Control in Manual Mode](/images/blackbox-ide/supervise_and_control_in_manual_mode.png)
...
![Give AI More Power in Auto Mode](/images/blackbox-ide/give_ai_more_power_in_auto_mode.png)
...
![Live Edit](/images/blackbox-ide/live_edit.PNG)
...
![Interact Using Voice Images](/images/blackbox-ide/Interact_using_Voice_Images.png)
...
![Backtrack Work Using History](/images/blackbox-ide/Backtrack_work_using_history.png)
...
![Out of Credits Buy More](/images/blackbox-ide/out_of_credits_buy_more.png)
