...
Common questions about BlackboxAI Encrypted's security and usage.
...
### How do I access BlackboxAI Encrypted?

Simply select "BlackboxAI Encrypted" from the model selection menu in the BlackboxAI UI (web, desktop, or mobile app). Your conversations will automatically be protected with end-to-end encryption.
