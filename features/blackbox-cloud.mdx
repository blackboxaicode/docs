---
title: "BLACKBOX AI Agents"
description: "Leverage the power of Blackbox agents remotely through your browser with BLACKBOX AI Agents, enabling simultaneous task execution, monitoring, and pull request management on any codebase."
---
...
<CardGroup>
  ...
  <Card title="BLACKBOX AI Agents SMS" icon="message" href="./blackbox-cloud-sms">
    Interact with agents via SMS for hands-free task management.
  </Card>

  <Card title="BLACKBOX AI Agents Voice" icon="phone" href="./blackbox-cloud-voice">
