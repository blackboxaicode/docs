...
1. **Access the Platform**  
   ...
   ![Login Options](/images/blackbox-cloud/cloud_login_google_or_git.png)
...
Blackbox Cloud provides a seamless and intuitive interface to manage your AI-powered development agents remotely.

Blackbox will create a new project from scratch, work on existing ones, add features, resolve bugs by creating a separate branch and making the changes on it. It will also create a PR once the changes are done giving the user minimal work and maximum control on what changes are being added to the main branch.
...
![Task Status Overview](/images/blackbox-cloud/clout_task_status.png)
...
![Task Status](/images/blackbox-cloud/clout_task_status.png)
