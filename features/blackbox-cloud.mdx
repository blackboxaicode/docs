...
2. **Add Mobile Number**  
   In the "SMS Notification" section under "Manage API Keys," enter your mobile number. This allows you to receive notifications about task progress and completion.
