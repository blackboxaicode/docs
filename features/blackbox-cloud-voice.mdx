...
Once configured, you're ready to use the Voice feature. Simply call the agent's mobile number **+1(940)290-8999** from your configured mobile number to start giving tasks to the remote agent.
