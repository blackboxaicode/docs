...
2. **Add Mobile Number**
   ...
   In the "SMS Notification" section, enter your mobile number. This is the mobile number that you can use to interact with the agent and receive notifications about task progress and completion.
