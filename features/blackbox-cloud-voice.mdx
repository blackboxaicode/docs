...
2. **Add Mobile Number**  
   ...
   In the "SMS Notification" section, enter your mobile number. This is the mobile number that you can use to interact with the agent and also allows you to receive notifications about task progress and completion.
