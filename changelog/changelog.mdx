...
<Update label="Oct 30" description="Full Self Coding">
  **New Full Self Coding Feature**
  ...
  - Connect production servers and stream logs/errors in real time to the agent.
  - Pick from different agents to triage, implement fixes, or review changes.
  - Runs tests on each implementation to confirm stability before approval.
  - Background operation keeps telemetry flowing without blocking your work.
  - Read the documentation: [Full Self Coding](/features/full-self-coding)
</Update>
