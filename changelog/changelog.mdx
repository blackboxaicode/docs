...
<Update label="Sep 20" description="BLACKBOX CLI">
  **BLACKBOX CLI: BLACKBOX Agent available through CLI**

  What’s New

  - BLACKBOX AI now is providing the Agent directly through the CLI
  - Use it with the best selection of closed source and open source models
  - See more details for installation & setup steps [here](https://docs.blackbox.ai/features/blackbox-cli)
</Update>
