...
<Update label="Oct 20" description="Multi-Agent Execution in BLACKBOX AI Cloud">
  **New Multi-Agent Parallel Execution Feature in BLACKBOX AI Cloud**
  ...
  - Checkout the detailed documentation for the [Mutli-Agent feature BLACKBOX Cloud](/features/blackbox-cloud#multi-agent-parallel-execution)
</Update>

<Update label="Oct 17" description="Slack Integration in BLACKBOX AI Cloud">
  **New Slack Integration Feature in BLACKBOX AI Cloud**
...
<Update label="Oct 16" description="SMS and Voice Support in BLACKBOX AI Cloud">
  **New SMS and Voice Support Feature in BLACKBOX AI Cloud**
...
<Update label="Oct 7" description="Launch of BLACKBOX AI Cloud">
  **Launch of BLACKBOX AI Cloud**
...
<Update label="Jul 28" description="Desktop Agent">
  **Desktop Agent Enhancements and End-to-End Encryption**
  ...
  - Checkout the documentation for the [Desktop Agent Enhancements](//features/vscode-agent/key-features)
</Update>
