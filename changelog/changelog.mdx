...
<Update label="Sep 15" description="E2E Encryption">
  ...
  * Black Box AI now has End-to-End Encryption support for enhanced security and privacy.
...
<Update label="Sep 9" description="BlackBox Builder Voice Capabilities">
  **BlackBox AI Builder Voice Capabilities**
...
<Update label="Sep 8" description="BlackBox Video Capabilities">
  **BlackBox AI Builder Video Capabilities**
  ...
  * Powered by advanced AI models such as Google's Veo-2 for high-quality video output.
</Update>

<Update label="Sep 5" description="BlackBox Image Generation">
  **BlackBox AI Builder Image Generation**
...
<Update label="Aug 27" description="Black Box Chat Integration">
...
<Update label="Aug 19" description="/chat/completions">
  ...
  * Utilizes industry-leading AI models such as Google's Veo-2.
...
<Update label="Aug 5" description="/chat/completions">
  ...
  * Leverages advanced AI models like Black Forest Labs' Flux Pro.
...
<Update label="Jul 29" description="/chat/completions">
  ...
  * Includes models from OpenAI, Anthropic, Google, and Meta.
...
<Update label="Jul 28" description="Desktop Agent">
  **Desktop Agent Enhancements and E2E Encryption**

  What's New

  * Added E2E Encryption supported agent to BlackBox AI Desktop Agent for enhanced security and privacy.
